...
def main():
    ...
    args = ("normal", {}, df, strat_v5_0, settings, base_risk)
    
    with ProcessPoolExecutor() as executor:
        results = list(executor.map(run_single_stress_scenario, [args]))
        
    print(f"Parallel Run PnL: ${results[0][1]:.2f}")
